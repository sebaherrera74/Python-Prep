...
# 2) Crear dos variables y un condicional que informe si son 
...
# 3) Para los valores enteros del 1 al 20, imprimir por 
...
# 4) En un ciclo for mostrar para los valores entre 0 y 5 el 
# resultado de elevarlo a la potencia igual a 3

# In[9]:

for i in range (0,5):
     print('El valor', str(i), 'elevado al cubo es', str(i**3))
...
# 13) Utilizar la función **input()** que permite hacer ingresos por teclado, 
...
# 14) Crear un ciclo while que encuentre dentro del rango de 100 a 300 el
#  primer número divisible por 3 y además múltiplo de 6
